import ObjCClass from './mocha-js-delegate'
import parseWebArguments from './parseWebArguments'
...
export function setDelegates (browserWindow, panel, webview, options) {
