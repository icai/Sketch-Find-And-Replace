...
import buildWebAPI from './webview-api'
import fitSubviewToView from './fitSubview'
import dispatchFirstClick from './dispatch-first-click'
import injectClientMessaging from './inject-client-messaging'
import * as movableArea from './movable-area'
import * as executeJavaScript from './execute-javascript'
import { setDelegates } from './set-delegates'
...
export const fromId = function (identifier) {
  var threadDictionary = NSThread.mainThread().threadDictionary()

  if (threadDictionary[identifier]) {
    return fromPanel(threadDictionary[identifier], identifier)
  }

  return undefined
}

export const fromPanel = function (panel, identifier) {
  var browserWindow = new EventEmitter()
  browserWindow.id = identifier
